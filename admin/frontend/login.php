                                ...
                                <div class="p-5">
                                    ...
                                    <form action="../auth/loginBackend.php" method="post" class="user">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" name="adminEmail"
                                                placeholder="Enter Email Address..." required>
                                            <span id="emailErr" class="help-login"><?php echo isset($_SESSION['emailErr']) ? $_SESSION['emailErr'] : ''; unset($_SESSION['emailErr']); ?></span>
                                        </div>
                                        <div class="form-group">
