                                ...
                                <div class="card card-body">
                                    ...
                                    <form action="../backend/changeUsername.php" method="POST">
                                        <div class="form-group">
                                            <input type="text" name="name" id="name" class="form-control form-control-user" placeholder="Enter Username">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="password" id="password" class="form-control form-control-user" placeholder="Enter Password">
                                        </div>
                            ...
                            <div class="collapse" id="password_change">
                                <div class="card card-body">
                                    <form action="" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="password" name="confirmPassword" id="confirmPassword" class="form-control form-control-user" placeholder="Re-enter New Password">
                                        </div>
                                            ...
                                            ?>
                                                <label class="form-control form-control-user" style="height: 45px;">
                                                    ...
                                                    <span style="line-height: 30px;">
                                                        <?php echo $row['bank_name'] . " : " . $row['account_number'] . " - " . $row['account_name']; ?>
                                                    </span>
